    ...
    try:
       ...
       if get_api['success'] == "ok":
          if get_api.get('result').get('hd'):
             try:
                 dump_file = await message.reply_video(get_api['result']['hd'],caption="Thank you for using - @DeadlineReelbot 📢")
             except KeyError:
                 pass 
             except Exception:
                 try:
                     ...
                     try:
                        ...
                        await message.reply_video(down_file,caption="Thank you for using - @DeadlineReelbot 📢")
                        await sndmsg.delete()
                        os.remove(down_file)
                     except:
             ...
             if get_api.get('result').get('sd'):
               try:
                   dump_file = await message.reply_video(get_api['result']['sd'],caption="Thank you for using - @DeadlineReelbot 📢")
               except KeyError:
                   pass
               except Exception:
                   try:
